...
class FrameService {
    constructor(dispatcher, wdow, wdowRemote, origin, remoteDispatcherId, id, logConfig) {
        ...
        __classPrivateFieldGet(this, _FrameService_window, "f").addEventListener("message", __classPrivateFieldGet(this, _FrameService_instances, "m", _FrameService_handleMessage).bind(this));
        __classPrivateFieldGet(this, _FrameService_window, "f").addEventListener("beforeUnload", __classPrivateFieldGet(this, _FrameService_instances, "m", _FrameService_handleBeforeUnload).bind(this));
    }
    get id() {
