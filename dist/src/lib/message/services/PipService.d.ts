...
declare class FrameService implements MessageService {
    #private;
    constructor(dispatcher: MessageDispatcher, wdow: Window, origin: string, remoteDispatcherId: string, id?: string, logConfig?: LogConfig);
    get id(): string;
    get dispatcherId(): string;
    get remoteDispatcherId(): string;
    get window(): Window;
    get type(): "event" | "frame" | "navigation";
    get logger(): Logger;
